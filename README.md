...
- [👤 User Roles](#-user-roles)
  - [1. Client (Service Consumer)](#1-client-service-consumer)
  - [2. Worker (Service Provider)](#2-worker-service-provider)
  - [3. Admin (Platform Manager)](#3-admin-platform-manager)
- [📦 Core Modules](#-core-modules)
  - [1. User Management Module](#1-user-management-module)
  - [2. Worker Management & Verification Module](#2-worker-management--verification-module)
  - [3. Service Booking Module](#3-service-booking-module)
  - [4. Payment Management Module](#4-payment-management-module)
  - [5. Review & Rating Module](#5-review--rating-module)
  - [6. Notification System](#6-notification-system)
  - [7. Admin Panel Module](#7-admin-panel-module)
- [🚀 Installation & Setup](#-installation--setup-developer-guide)
