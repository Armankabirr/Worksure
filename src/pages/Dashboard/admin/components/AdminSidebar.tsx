...
const AdminSidebar = () => {
  ...
  const [user, setLocalUser] = React.useState<any>(null);
  ...
  return (
    <aside className="w-64 bg-white border-r border-gray-200 flex flex-col">
      ...
      <div className="p-4 border-t border-gray-200 space-y-2">
        ...
        <button
          onClick={() => navigate('/')}
          className="w-full flex items-center gap-3 px-4 py-2 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition-colors border border-gray-200"
        >
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-4 py-2 rounded-lg text-sm font-medium text-red-700 hover:bg-red-50 transition-colors border border-red-200"
        >
