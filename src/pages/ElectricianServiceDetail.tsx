...
const ElectricianServiceDetail = () => {
  ...
  const howItWorks = [
    ...
    },
    {
      ...
      description: "We match you with a licensed, background-checked electrician based on your requirements.",
    },
    {
      title: "Service Completed & Verified",
      description: `Our team completes the ${serviceData.title.toLowerCase()}, performs a safety check, and ensures your satisfaction.`,
    },
  ];
                ...
                <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-border/70">
                  ...
                  <div className="absolute left-4 bottom-4 space-y-2">
                    <div className="rounded-xl bg-background/90 border border-border px-4 py-2 shadow-sm backdrop-blur">
                      ...
                      <p className="text-sm font-semibold">Licensed & Insured Electricians</p>
                    </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12 animate-fade-up">
              ...
              <p className="text-muted-foreground mt-3 max-w-2xl mx-auto">
                Our comprehensive {serviceData.title.toLowerCase()} service covers all aspects with meticulous attention to safety and quality.
              </p>
            </div>
                ...
                <Card className="border-2 border-primary/20 animate-fade-up" style={{ animationDelay: "100ms" }}>
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      Final price depends on project scope, complexity, and specific requirements. We provide a detailed quote before starting work.
                    </p>
                  </CardContent>
                </Card>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="border-none bg-card shadow-sm animate-fade-up" style={{ animationDelay: "100ms" }}>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Every electrician is fully licensed, insured, and background-checked before joining our team.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-none bg-card shadow-sm animate-fade-up" style={{ animationDelay: "150ms" }}>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    All work meets or exceeds local electrical codes and safety standards.
                  </p>
                </CardContent>
              </Card>
            ...
            <Card className="mt-8 bg-primary/5 border-primary/20 animate-fade-up" style={{ animationDelay: "250ms" }}>
              <CardContent className="p-6">
                <p className="text-center text-muted-foreground">
                  ...
                  Your safety is our most valuable priority, and we work hard to ensure it every single day.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <section className="bg-primary text-primary-foreground">
          <div className="container mx-auto px-6 py-14 flex flex-col md:flex-row md:items-center md:justify-between gap-6 animate-fade-up" style={{ animationDelay: "80ms" }}>
            <div>
              ...
              <h3 className="text-2xl md:text-3xl font-bold mt-2">Transform Your Electrical System Today</h3>
              <p className="text-primary-foreground/80 mt-2">
                Book your {serviceData.title.toLowerCase()} service now and experience the difference of professional, safe electrical work.
              </p>
            </div>
...
export default ElectricianServiceDetail;
