...
const DeepCleaning = () => {
  ...
  const howItWorks = [
    ...
    },
    {
      ...
      description: "We match you with a certified, background-checked cleaner based on your requirements.",
    },
    {
                ...
                <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-border/70">
                  ...
                  <div className="absolute left-4 bottom-4 space-y-2">
                    <div className="rounded-xl bg-background/90 border border-border px-4 py-2 shadow-sm backdrop-blur">
                      ...
                      <p className="text-sm font-semibold">Certified & Insured Cleaners</p>
                    </div>
                ...
                <Card className="border-2 border-primary/20 animate-fade-up" style={{ animationDelay: "100ms" }}>
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      Final price depends on property size, number of rooms, and specific requirements. We provide a detailed quote before starting work.
                    </p>
                  </CardContent>
                </Card>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="border-none bg-card shadow-sm animate-fade-up" style={{ animationDelay: "100ms" }}>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Every cleaner undergoes thorough background checks and verification before joining our team.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-none bg-card shadow-sm animate-fade-up" style={{ animationDelay: "150ms" }}>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    We use only safe, non-toxic, eco-friendly cleaning products that protect your family and environment.
                  </p>
                </CardContent>
              </Card>
