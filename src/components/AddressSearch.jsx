  ...
  return (
    <div ref={containerRef} style={{ position: 'relative', width: '100%' }}>
      <input
        ...
        className='w-full h-[55px] rounded-lg p-2 border border-gray-300 text-base shadow-sm transition-all duration-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:outline-none hover:border-gray-400'
      />
